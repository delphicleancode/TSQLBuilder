...
begin
  ...
  SQLWithNull := TSQL.UPDATE('vendas')
...
var
  ...
  SQL: string;
begin
  Filtros := TVariantMap.Create;
  // Configuração do mapa
  Filtros.Sorted := True;
  Filtros.Duplicates := dupError;
  try
